        ...
        <>
            ...
            <div className="homeDesign">
                ...
                <div className="homeImg">
                    <img src="../../../img/tatuarse-estando-resfriado.jpg"/>
                </div>
            </div>
            <div className="homeStyles">
                ...
                <div className="styles">
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\traditionalStyle.png" alt="" /><p>TRADITIONAL</p></div>
                    ...
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\neotradicionalStyle.png" alt="" /><p>NEOTRADICIONAL</p></div>
                    ...
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\newSchoolStyle.png" alt="" /><p>NEWSCHOOL</p></div>
                        <div className="styleText">Imagine 'cartoon', combining bright tones and thick lines to create fun but solid tattoos</div>
                    </div>
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\blackworkStyle.png" alt="" /><p>BLACKWORK</p></div>
                    ...
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\realismStyle.png" alt="" /><p>REALISM</p></div>
                    ...
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\dotworkStyle.png" alt="" /><p>DOTWORK</p></div>
                    ...
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\biomechanicStyle.png" alt="" /><p>BIOMECÁNICO</p></div>
                    ...
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\orientalStyle.png" alt="" /><p>ORIENTAL</p></div>
                    ...
                    <div className="style">
                        <div className="styleLogo"><img src="../../img\letteringStyle.png" alt="" /><p>LETTERING</p></div>
